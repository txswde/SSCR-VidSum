...
def analyze_summe_gt():
    h5_path = 'data/SumMe/feature/eccv16_dataset_summe_google_pool5.h5'
    ...
    with h5py.File(h5_path, 'r') as f:
        ...
        for vid in videos:
            ...
            user_summary = f[vid]['user_summary'][...]
            
            # Print first video stats
            if len(all_means) == 0:
                print(f"\nExample Video: {vid}")
                ...
                print(f"user_summary shape: {user_summary.shape}")
